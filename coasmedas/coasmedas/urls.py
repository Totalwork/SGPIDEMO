...
urlpatterns = [
    ...
    path('', views.inicio, name='coasmedas.inicio'), 
...
from coasmedas import views as coasmedas_views

urlpatterns += [
    # Other url patterns ...
    path('sitio-en-construccion/', coasmedas_views.sitio_construccion, name='sitio_construccion'),
]

handler404 = 'coasmedas.views.error_404'
handler500 = 'coasmedas.views.error_500'
