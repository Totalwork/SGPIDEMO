   ...
   // self.url=path_principal+'api/Banco'; 
           ...
           // self.contratistaVO.logo($('#archivo')[0].files[0]);
            ...
            if(self.actividadVO.id()==0){
                ...
                var parametros={                     
                     ...
                     url:path_principal+'/api/avanceObraGraficoEsquemaCapitulosActividades/',//url api
                ...
                Request(parametros);
                  ...
                  var parametros={     
                       ...
                       url:path_principal+'/api/avanceObraGraficoEsquemaCapitulosActividades/'+self.actividadVO.id()+'/',
                       parametros:self.actividadVO                        
                  };
    ...
    self.consultar_por_id = function (obj) {
      ...
      // alert(obj.id)
       ...
       path =path_principal+'/api/avanceObraGraficoEsquemaCapitulosActividades/'+obj.id+'/?format=json';
