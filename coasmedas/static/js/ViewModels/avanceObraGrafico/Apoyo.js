function EnlaceViewModel(){
  ...
  self.apoyoVO={
    ...
    self.cargar = function () {
            ...
            parameter = { presupuesto_id:$('#id_presupuesto').val(),dato: filtro_avance};
  ...
  self.descargar_plantilla=function(){
         location.href=path_principal+"/avanceObraGrafico/descargar_plantilla_apoyo/";
  ...
  self.guardar_datos=function(){
         ...
         if(self.archivo_carga()==''){
            ...
            var parametros={                     
                     ...
                     url:path_principal+'/avanceObraGrafico/guardar_apoyo_archivo/',//url api
                     parametros:data                       
                };
                //parameter =ko.toJSON(self.contratistaVO);
  ...
  self.eliminar_punto = function (id) {
             ...
             var path =path_principal+'/avanceObraGrafico/eliminar_id_apoyo/';
             var parameter = {id:id};
