function EnlaceViewModel(){
  ...
  self.apoyoVO={
    ...
    self.eliminar=function(){
       ...
       var lista_id=[];
         ...
         if(count==0){
             ...
             var path =path_principal+'/avanceObraGrafico/eliminar_apoyos/';
    ...
    self.cargar = function (pagina) {
     ...
     self.consultar_por_id = function (obj) {
      ...
      // alert(obj.id)
        path =path_principal+'/api/avanceObraGraficoNodo/'+obj.id+'/?format=json';
  ...
  self.descargar_plantilla=function(){
         location.href=path_principal+"/avanceObraGrafico/descargar_plantilla_apoyo_sinposicion/";
