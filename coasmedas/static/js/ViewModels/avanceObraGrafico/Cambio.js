function IndexViewModel() {
   ...
   // self.url=path_principal+'api/Banco'; 
    ...
    self.cargar =function(pagina){           
            ...
            path = path_principal+'/api/avanceObraGraficoCambio/?format=json&page='+pagina;
            parameter = {dato: filtro_avance, pagina: pagina};
    ...
    self.abrir_detalle_cambio=function(obj){
        location.href=path_principal+"/avanceObraGrafico/detalle_cambio/"+$('#id_proyecto').val()+"/"+obj.cronograma.id+"/"+obj.id+"/";
    }
