function IndexViewModel() {
   ...
   // self.url=path_principal+'api/Banco';   
    ...
    self.abrir_cronograma_proyecto=function(obj){

         path = path_principal+'/api/avanceObraGraficoCantidadNodo/?format=json&sin_paginacion';
            parameter = {presupuesto_id:obj.id};
            RequestGet(function (datos, estado, mensage) {

                if (estado == 'ok' && datos!=null && datos.length > 0) { 

                  location.href=path_principal+"/avanceObraGrafico/cronograma_proyecto/"+obj.id+"/"+obj.proyecto.id+"/";

                } else {
                   $.confirm({
                        title:'Informativo',
                        content: '<h4><i class="text-info fa fa-info-circle fa-2x"></i>Debe registrar las cantidades de nodos antes de crear el cronograma.<h4>',
                        cancelButton: 'Cerrar',
                        confirmButton: false
                    });
    ...
    self.cargar =function(pagina){           
            ...
            parameter = { alcance:0,empresa:$('#id_empresa').val(),dato: filtro_avance, pagina: pagina, departamento:departamento_id_avance,
