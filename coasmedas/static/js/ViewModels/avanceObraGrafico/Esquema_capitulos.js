function AdministrarViewModel() {
   ...
   // self.url=path_principal+'api/Banco';   
    ...
    self.clonar_esquema=function(){
        ...
        if (AdministrarViewModel.errores_clonacion().length == 0) {//se activa las validaciones
                ...
                var parametros={                     
                     ...
                     url:path_principal+'/avanceObraGrafico/clonacion_esquema/',//url api
    ...
    self.agregar_capitulos=function(obj){
        ...
        location.href=path_principal+"/avanceObraGrafico/actividades/"+obj.id;
    }

    self.regla_estado=function(obj){
        
        location.href=path_principal+"/avanceObraGrafico/regla_estado/"+obj.id;
    }
    ...
    self.consultar = function (pagina) {
        if (pagina > 0) {            
            ...
            path = path_principal+'/api/avanceObraGraficoEsquemaCapitulos/?format=json&page='+pagina;
    ...
    self.consultar_por_id = function (obj) {
      ...
      // alert(obj.id)
       path =path_principal+'/api/avanceObraGraficoEsquemaCapitulos/'+obj.id+'/?format=json';
           ...
           // self.contratistaVO.logo($('#archivo')[0].files[0]);
            ...
            if(self.etiquetaVO.id()==0){
                ...
                var parametros={                     
                     ...
                     url:path_principal+'/api/avanceObraGraficoEsquemaCapitulos/',//url api
                ...
                Request(parametros);
                  ...
                  var parametros={     
                       ...
                       url:path_principal+'/api/avanceObraGraficoEsquemaCapitulos/'+self.etiquetaVO.id()+'/',
                       parametros:self.etiquetaVO                        
                  };
    ...
    self.eliminar = function () {
         ...
         if(count==0){
             ...
             var path =path_principal+'/avanceObraGrafico/eliminar_esquema/';
