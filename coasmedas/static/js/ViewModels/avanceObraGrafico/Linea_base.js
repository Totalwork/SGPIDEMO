...
function IndexViewModel() {
    ...
    self.cerrado_cronograma=ko.observable($('#cerrado_cronograma').val()); 
   ...
   self.valor_total=ko.observable(0);
    ...
    self.cargar =function(pagina){     
            ...
            parameter = {cronograma_id:$('#id_cronograma').val(),tipo_linea:1,pagina: pagina,filtro_porcentaje:1};
    ...
    self.descargar_plantilla=function(){
             ...
             location.href=path_principal+"/avanceObraGrafico/descargar_plantilla_lineabase?cronograma_id="+$('#id_cronograma').val()+"&tipo_linea=1";
