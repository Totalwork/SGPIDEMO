function ReglaViewModel() {
    ...
    self.reglaVO={
        ...
        nombre:ko.observable('').extend({ required: { message: '(*)Digite el nombre del estado' } }),
    ...
    self.regla_anterior=function(){
        ...
        path =path_principal+'/api/avanceObraGraficoReglaEstado/?format=json&sin_paginacion';
    ...
    self.consultar_por_id = function (obj) {
      ...
      // alert(obj.id)
         ...
         path =path_principal+'/api/avanceObraGraficoReglaEstado/'+obj.id()+'/?format=json';
         RequestGet(function (results,count) {
           
             self.titulo('Actualizar Regla');

             self.reglaVO.id(results.id);
             self.reglaVO.nombre(results.nombre);
           ...
           self.reglaVO.esquema_id($('#id_esquema').val());
            ...
            if(self.reglaVO.id()==0){
                ...
                var parametros={                     
                     ...
                     url:path_principal+'/api/avanceObraGraficoReglaEstado/',//url api
                ...
                Request(parametros);
                  ...
                  var parametros={     
                       ...
                       url:path_principal+'/api/avanceObraGraficoReglaEstado/'+self.reglaVO.id()+'/',
                       parametros:self.reglaVO                        
                  };
    ...
    self.eliminar = function () {
         ...
         if(count==0){
             ...
             var path =path_principal+'/avanceObraGrafico/eliminar_id_regla_estado/';
