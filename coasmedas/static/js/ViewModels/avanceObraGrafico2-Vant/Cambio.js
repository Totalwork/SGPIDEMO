...
function IndexViewModel() {
   ...
   // self.url=path_principal+'api/Banco';   
    ...
    self.cambio=function(obj){
         location.href=path_principal+"/avanceObraGrafico2/index_cambio/"+obj.id+"/";
    }
    ...
    self.cargar =function(pagina){           
            ...
            let filtro_avance=sessionStorage.getItem("filtro_avance_cambio");
            ...
            parameter = { empresa:$('#id_empresa').val(),dato: filtro_avance, pagina: pagina,cerrado_presupuesto:1};
            RequestGet(function (datos, estado, mensage) {
