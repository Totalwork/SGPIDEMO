function IndexViewModel() {
   ...
   self.listado_actividades=ko.observableArray([]);
    ...
    self.cargar =function(pagina){           
            ...
            hito_id:self.busquedaVO.hito_id(),actividad_id:self.busquedaVO.actividad_id()};
            RequestGet(function (datos, estado, mensage) {
    ...
    self.guardar=function(){
         ...
         if(self.archivo_carga()==''){
            ...
            var parametros={                     
                     ...
                     url:path_principal+'/avanceObraGrafico2/guardar_presupuesto_archivo/',//url api
                     parametros:data                       
                };
    ...
    self.guardar_cantidad=function(){
         ...
         var parametros={     
                ...
                callback:function(datos, estado, mensaje){
                     ...
                     url:path_principal+'/avanceObraGrafico2/actualizar_cantidad/',//url api
        ...
        self.valor_total(0);
         ...
         if(self.cerrado_presupuesto()==true || self.cerrado_presupuesto()=='True'){
          ...
          ko.utils.arrayForEach(data, function(obj) {
                    ...
                    self.valor_total(parseInt(obj.sumaPresupuesto));
             });
        return lista;
    }
    ...
    self.descargar_plantilla=function(){
             ...
             location.href=path_principal+"/avanceObraGrafico2/descargar_plantilla_presupuesto?id_esquema="+$('#id_esquema').val();
    ...
    self.exportar_excel=function(){
         ...
         location.href=path_principal+"/avanceObraGrafico2/informe_detallepresupuesto?presupuesto_id="+$('#id_presupuesto').val();   
        ...
        $.confirm({
            ...
            confirm: function() {
                ...
                callback:function(datos, estado, mensaje){
                     ...
                     url:path_principal+'/avanceObraGrafico2/reportar_sin_poste/',//url api
