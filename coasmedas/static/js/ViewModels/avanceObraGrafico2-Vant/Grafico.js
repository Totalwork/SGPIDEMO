...
function IndexViewModel() {
   ...
   // self.url=path_principal+'api/Banco';  
    ...
    self.cargar =function(pagina){     
            ...
            path = path_principal+'/avanceObraGrafico2/consultar_graficos/';
            parameter = {presupuesto_id:$('#presupuesto_id').val()};
            RequestGet(function (datos, estado, mensage) {

                self.mostrar_grafica_linea(datos.programada,'#high-line1','Linea Programada');
