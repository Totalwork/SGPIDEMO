...
google.maps.event.addListener(map, 'zoom_changed', function() {
  ...
  self.descargar_plantilla=function(){
         location.href=path_principal+"/avanceObraGrafico2/descargar_plantilla_apoyo/";
  ...
  self.guardar_datos=function(){
         ...
         if(self.archivo_carga()==''){
            ...
            var parametros={                     
                     ...
                     url:path_principal+'/avanceObraGrafico2/guardar_apoyo_archivo/',//url api
                     parametros:data                       
                };
                //parameter =ko.toJSON(self.contratistaVO);
  ...
  self.eliminar_punto = function (id) {
    ...
    self.consultarCantidades = function(nodo_id,presupuesto_id) {
      //consume el servicio http://localhost:8000/avanceObraGrafico2/cantidadesnodo/nodo_id/presupuesto_id/
      //alert(nodo_id.toString() + ', ' + presupuesto_id.toString());
      
      path = path_principal+'/avanceObraGrafico2/cantidadesnodo/'+ 
