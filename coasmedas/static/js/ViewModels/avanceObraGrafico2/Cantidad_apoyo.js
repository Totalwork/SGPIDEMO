function IndexViewModel() {
   ...
   self.listado_actividades=ko.observableArray([]);
    ...
    self.cargar =function(pagina){           
            ...
            parameter = {dato: filtro_avance,presupuesto_id:$('#id_presupuesto').val(),
            hito_id:self.busquedaVO.hito_id(),pagina: pagina,actividad_id:self.busquedaVO.actividad_id(),lite2:1};
            RequestGet(function (datos, estado, mensage) {
    ...
    self.consultar_id=function(obj){
          ...
          location.href=path_principal+"/avanceObraGrafico2/cantidad_apoyo_id/"+$('#id_presupuesto').val()+"/"+obj.id()+"/";
    ...
    self.guardar=function(){
         ...
         if(self.archivo_carga()==''){
            ...
            var parametros={                     
                     ...
                     url:path_principal+'/avanceObraGrafico2/guardar_cantidadApoyo_archivo/',//url api
                     parametros:data                       
                };
    ...
    self.guardar_presupuesto=function(){
        ...
        var parametros={     
                ...
                callback:function(datos, estado, mensaje){
                     ...
                     url:path_principal+'/avanceObraGrafico2/cierre_presupuesto/',//url api
    ...
    self.descargar_plantilla=function(){
             ...
             location.href=path_principal+"/avanceObraGrafico2/descargar_plantilla_cantidadApoyo?presupuesto_id="+$('#id_presupuesto').val();

    }

    self.descargar_informe=function(){

             location.href=path_principal+"/avanceObraGrafico2/informe_cantidad_apoyo?presupuesto_id="+$('#id_presupuesto').val();
