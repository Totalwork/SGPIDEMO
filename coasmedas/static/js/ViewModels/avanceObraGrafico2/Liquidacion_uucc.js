function LiquidacionuuccViewModel(){
    ...
    self.url_funcion=path_principal+'/avanceObraGrafico2/';
            ...
            confirm: function() {
                ...
                if(count==0){
                    ...
                    var parametros={                     
                             ...
                             alerta:false,
                             url:path_principal+'/avanceObraGrafico2/guardar_liquidacionuucc/',//url api
                             parametros:{
                                lista:lista_id,
    ...
    self.mostrar_movtivo_anulación=function(liquidacion_id){
        ...
        path = path_principal+'/avanceObraGrafico2/consultarmotivoanulacion/';
        parameter={
    ...
    self.consultar_detallereportetrabajo = function(){
        path = path_principal+'/avanceObraGrafico2/consultar_detallereporte_liquidacion/';
        parameter={
    ...
    self.consultar_uucc_ejecutadas = function(opcion,liq_id){
    	...
    	path = path_principal+'/avanceObraGrafico2/consultarcantidadesaliquidarlite/';
    ...
    self.exportar_excel = function (liquidacion_id) {        
        ...
        location.href=path_principal+"/avanceObraGrafico2/exportReporteLiquidacion?liquidacion_id="+liquidacion_id
        ...
        //alert(self.liquidacionAnular.motivo_anular());
         if (LiquidacionuuccViewModel.errores_liquidacion().length == 0) {
                var parametros={                     
                     ...
                     alerta:false,
                     url:path_principal+'/avanceObraGrafico2/anularReporteLiquidacion/',//url api
                     parametros:{
                        liquidacion_id:self.liquidacionAnular.id(),
    ...
    self.cerrar_liquidacion = function(){
        var parametros={
             ...
             alerta:false,
             url:path_principal+'/avanceObraGrafico2/cerrar_liquidacionuucc/',//url api
             parametros:{
                liquidacion_id:self.liquidacionVO.id()
            }                       
        };
