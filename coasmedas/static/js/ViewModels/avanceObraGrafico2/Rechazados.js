   ...
   // self.url=path_principal+'api/Banco';   
     ...
     self.llenar_datos=function(data){
        ...
        ko.utils.arrayForEach(data, function(obj) {
              ...
              lista.push({
                            ...
                            totalRechazados:ko.observable(obj.totalRechazados)                        
                        });
    ...
    self.cargar =function(pagina){           
            ...
            parameter = { empresa:$('#id_empresa').val(),dato: filtro_avance, pagina: pagina, departamento:departamento_id_avance,
                municipio:municipio_id_avance,mcontrato:macrocontrato_id_avance, contratista:contratista_id_avance,rechazados:0};
            RequestGet(function (datos, estado, mensage) {
    ...
    self.reporte=function(obj){
        location.href=path_principal+"/avanceObraGrafico2/reporte_trabajo_rechazados/"+obj.id()+"/";
    }
