...
function IndexViewModel() {
   ...
   // self.url=path_principal+'api/Banco';   
     ...
     self.registrado=ko.observable(1);
    ...
    self.cronograma=function(obj){
        ...
        location.href=path_principal+"/avanceObraGrafico2/cronograma_proyecto/"+obj.proyecto.id;
    }
        ...
        ko.utils.arrayForEach(data, function(obj) {
                ...
                if(sw==1){
                    lista.push({
                            ...
                            totalRegistrados:ko.observable(obj.totalRegistrados),
                            totalAprobados:ko.observable(obj.totalAprobados)                             
                        });
                }
    ...
    self.cargar =function(pagina){           
            ...
            parameter = { empresa:$('#id_empresa').val(),dato: filtro_avance, pagina: pagina, departamento:departamento_id_avance,
                municipio:municipio_id_avance,mcontrato:macrocontrato_id_avance, contratista:contratista_id_avance,registrado:self.registrado(),aprobado:self.aprobado()};
            RequestGet(function (datos, estado, mensage) {
    ...
    self.reporte=function(obj){
        location.href=path_principal+"/avanceObraGrafico2/reporte_trabajo_registrado/"+obj.id()+"/";
    }
