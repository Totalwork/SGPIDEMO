function ReglaViewModel() {
    ...
    self.regla_anterior=function(){
        ...
        path =path_principal+'/api/avanceGrafico2ReglaEstado/?format=json&sin_paginacion';
    ...
    self.consultar_por_id = function (obj) {
      ...
      // alert(obj.id)
         ...
         path =path_principal+'/api/avanceGrafico2ReglaEstado/'+obj.id()+'/?format=json';
           ...
           self.reglaVO.esquema_id($('#id_esquema').val());
            ...
            if(self.reglaVO.id()==0){
                ...
                var parametros={                     
                     ...
                     url:path_principal+'/api/avanceGrafico2ReglaEstado/',//url api
                ...
                RequestFormData(parametros);
                  ...
                  var parametros={     
                       ...
                       url:path_principal+'/api/avanceGrafico2ReglaEstado/'+self.reglaVO.id()+'/',
                       parametros:self.reglaVO                        
                  };
    ...
    self.eliminar = function () {
         ...
         if(count==0){
             ...
             var path =path_principal+'/avanceObraGrafico2/eliminar_id_regla_estado/';
