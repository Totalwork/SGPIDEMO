function IndexViewModel() {
   ...
   // self.url=path_principal+'api/Banco';   
    ...
    self.cargar =function(pagina){           
            ...
            parameter = {dato: filtro_avance, pagina: pagina,proyecto_id:$("#proyecto_id").val(),empresa_id:$('#id_empresa').val(),registrado:2};
    ...
    self.detalle_reporte=function(obj){
        ...
        location.href=path_principal+"/avanceObraGrafico2/detalle_corregido/"+obj.id+"/"; 
    }
