function IndexViewModel() {
    ...
    self.cargar =function(pagina){        
        ...
        path = path_principal+'/api/mano-obra/?format=json&page='+pagina;
    ...
    self.eliminar=function(){
        var lista_id=[];
         ...
         if(count==0){
             ...
             var path =path_principal+'/avanceObraGrafico2/eliminar_id_mano_obra/';
         ...
         if (IndexViewModel.errores_manoObra().length == 0) {//se activa las validaciones           
            if(self.manoObra.id()==0){
                var parametros={                     
                    ...
                    url:path_principal+'/api/mano-obra/',//url api
               ...
               RequestFormData(parametros);                                
                ...
                var parametros={
					...
					url:path_principal+'/api/mano-obra/'+self.manoObra.id()+'/',
					parametros:self.manoObra                        
				};
				RequestFormData(parametros);			
            }
    ...
    self.exportar_excel=function(){
        location.href=path_principal+"/avanceObraGrafico2/excel_mo/?dato="+self.filtro()+"&catalogo_id="+self.manoObra.catalogo_id();
    } 
    ...
    self.consultar_por_id=function(obj){         
        ...
        path = path_principal+'/api/mano-obra/'+obj.id+'/?format=json';
        parameter = {};
        RequestGet(function (datos, estado, mensage) {                        
