function SeguimientoMaterialesViewModel() {
    ...
    self.cargar =function(presupuesto_id){           
        ...
        path = path_principal+'/avanceObraGrafico2/consultarmaterialesaliquidarlite/' + presupuesto_id + '/';
        parameter = {};
    ...
    self.exportar_excel=function(presupuesto_id,proyecto_nombre){
        ...
        location.href=path_principal+"/avanceObraGrafico2/exportarmaterialesaliquidar?presupuesto_id="+presupuesto_id+"&proyecto="+proyecto_nombre
