function IndexViewModel() {
    ...
    self.cargar =function(pagina){        
        ...
        path = path_principal+'/api/unidadconstructiva/?format=json&page='+pagina;
    ...
    self.consultar_tipo_uucc = function(){        
        path = path_principal+'/api/tipounidadconstructiva/?format=json';
        parameter = {};
        RequestGet(function (datos, estado, mensage) {
    ...
    self.eliminar=function(){
        var lista_id=[];
         ...
         if(count==0){
             ...
             var path =path_principal+'/avanceObraGrafico2/eliminar_id_uucc/';
         ...
         if (IndexViewModel.errores_uucc().length == 0) {//se activa las validaciones           
            if(self.uucc.id()==0){
                var parametros={                     
                    ...
                    url:path_principal+'/api/unidadconstructiva/',//url api
               ...
               RequestFormData(parametros);                                
                ...
                var parametros={
					...
					url:path_principal+'/api/unidadconstructiva/'+self.uucc.id()+'/',
					parametros:self.uucc                        
				};
				RequestFormData(parametros);			
            }
    ...
    self.exportar_excel=function(){
		location.href=path_principal+"/avanceObraGrafico2/excel_uucc/?dato="+self.filtro()+"&catalogo_id="+self.uucc.catalogo_id();
    }  
    ...
    self.consultar_por_id=function(obj){         
        ...
        path = path_principal+'/api/unidadconstructiva/'+obj.id+'/?format=json';
        parameter = {};
        RequestGet(function (datos, estado, mensage) {                        
    ...
    self.desglose_mo = function(obj){        
        location.href=path_principal+"/avanceObraGrafico2/desgl_mo/"+obj.id+"/";
    }     
}
