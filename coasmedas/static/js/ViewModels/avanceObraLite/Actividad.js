   ...
   // self.url=path_principal+'api/Banco'; 
           ...
           // self.contratistaVO.logo($('#archivo')[0].files[0]);
            ...
            if(self.actividadVO.id()==0){
                ...
                var parametros={                     
                     ...
                     url:path_principal+'/api/avanceObraLiteEsquemaCapitulosActividades/',//url api
                ...
                RequestFormData(parametros);
                  ...
                  var parametros={     
                       ...
                       url:path_principal+'/api/avanceObraLiteEsquemaCapitulosActividades/'+self.actividadVO.id()+'/',
                       parametros:self.actividadVO                        
                  };
    ...
    self.consultar_por_id = function (obj) {
      ...
      // alert(obj.id)
       ...
       path =path_principal+'/api/avanceObraLiteEsquemaCapitulosActividades/'+obj.id+'/?format=json';
    ...
    self.eliminar = function () {
         ...
         if(count==0){
             ...
             var path =path_principal+'/avanceObraLite/eliminar_id_capitulo_actividad_esquema/';
