function EnlaceViewModel(){
  ...
  self.descargar_plantilla=function(){
         location.href=path_principal+"/avanceObraLite/descargar_plantilla_apoyo_sinposicion/";
  ...
  self.guardar_datos=function(){
         ...
         if(self.archivo_carga()==''){
            ...
            var parametros={                     
                     ...
                     url:path_principal+'/avanceObraLite/guardar_apoyo_archivo_sinposicion/',//url api
                     parametros:data                       
                };
                //parameter =ko.toJSON(self.contratistaVO);
