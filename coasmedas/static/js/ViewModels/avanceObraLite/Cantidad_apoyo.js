function IndexViewModel() {
   ...
   self.listado_actividades=ko.observableArray([]);
    ...
    self.consultar_id=function(obj){
          ...
          location.href=path_principal+"/avanceObraLite/cantidad_apoyo_id/"+$('#id_presupuesto').val()+"/"+obj.id()+"/";
    ...
    self.guardar=function(){
         ...
         if(self.archivo_carga()==''){
            ...
            var parametros={                     
                     ...
                     url:path_principal+'/avanceObraLite/guardar_cantidadApoyo_archivo/',//url api
                     parametros:data                       
                };
    ...
    self.descargar_plantilla=function(){
             ...
             location.href=path_principal+"/avanceObraLite/descargar_plantilla_cantidadApoyo?presupuesto_id="+$('#id_presupuesto').val();

    }

    self.descargar_informe=function(){

             location.href=path_principal+"/avanceObraLite/informe_cantidad_apoyo?presupuesto_id="+$('#id_presupuesto').val();
