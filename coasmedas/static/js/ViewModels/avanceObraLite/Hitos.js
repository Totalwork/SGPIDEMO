function AdministrarViewModel() {
   ...
   // self.url=path_principal+'api/Banco';   
    ...
    self.clonar_esquema=function(){
        ...
        if (AdministrarViewModel.errores_clonacion().length == 0) {//se activa las validaciones
                ...
                var parametros={                     
                     ...
                     url:path_principal+'/avanceObraLite/clonacion_esquema/',//url api
    ...
    self.agregar_capitulos=function(obj){
        ...
        location.href=path_principal+"/avanceObraLite/actividades/"+obj.id;
    }

    self.regla_estado=function(obj){
        
        location.href=path_principal+"/avanceObraLite/regla_estado/"+obj.id;
    }
    ...
    self.consultar = function (pagina) {
        if (pagina > 0) {            
            ...
            path = path_principal+'/api/avanceObraLiteEsquemaCapitulos/?format=json&page='+pagina;
    ...
    self.consultar_por_id = function (obj) {
      ...
      // alert(obj.id)
       path =path_principal+'/api/avanceObraLiteEsquemaCapitulos/'+obj.id+'/?format=json';
           ...
           // self.contratistaVO.logo($('#archivo')[0].files[0]);
            ...
            if(self.etiquetaVO.id()==0){
                ...
                var parametros={                     
                     ...
                     url:path_principal+'/api/avanceObraLiteEsquemaCapitulos/',//url api
                ...
                RequestFormData(parametros);
                  ...
                  var parametros={     
                       ...
                       url:path_principal+'/api/avanceObraLiteEsquemaCapitulos/'+self.etiquetaVO.id()+'/',
                       parametros:self.etiquetaVO                        
                  };
    ...
    self.eliminar = function () {
         ...
         if(count==0){
             ...
             var path =path_principal+'/avanceObraLite/eliminar_esquema/';
