function IndexViewModel() {
    ...
    self.cargar =function(pagina){             
        ...
        path = path_principal+'/api/avanceObraLiteDesgl-mat/?format=json&page='+pagina;
    ...
    self.consultar_materiales = function(){                
        path = path_principal+'/api/avanceObraLiteMateriales/?format=json';
    ...
    self.eliminar=function(){
        var lista_id=[];
         ...
         if(count==0){
             ...
             var path =path_principal+'/avanceObraLite/eliminar_id_desgl_mat/';
            ...
            if (IndexViewModel.errores_mat().length == 0) {//se activa las validaciones           
                ...
                if(self.desgl_mat.id()==0){
                    var parametros={                     
                        ...
                        url:path_principal+'/api/avanceObraLiteDesgl-mat/',//url api
                   ...
                   RequestFormData(parametros);                                
                    ...
                    var parametros={
                        ...
                        url:path_principal+'/api/avanceObraLiteDesgl-mat/'+self.desgl_mat.id()+'/',
                        parametros:self.desgl_mat                        
                    };
                    RequestFormData(parametros);			
                }
    ...
    self.exportar_excel=function(){
        location.href=path_principal+"/avanceObraLite/excel_desgl_mat/?dato="+self.filtro()+"&uucc_id="+self.desgl_mat.uucc_id();
    } 
    ...
    self.consultar_por_id=function(obj){         
        ...
        path = path_principal+'/api/avanceObraLiteDesgl-mat/'+obj.id+'/?format=json';
        parameter = {};
        RequestGet(function (datos, estado, mensage) {                        
