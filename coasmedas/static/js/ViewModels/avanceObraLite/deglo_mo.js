function IndexViewModel() {
    ...
    self.cargar =function(pagina){             
        ...
        path = path_principal+'/api/avanceObraLiteDesgl-mo/?format=json&page='+pagina;
    ...
    self.consultar_mo = function(){                
        path = path_principal+'/api/avanceObraLiteMano-obra/?format=json';
    ...
    self.eliminar=function(){
        var lista_id=[];
         ...
         if(count==0){
             ...
             var path =path_principal+'/avanceObraLite/eliminar_id_desgl_mo/';
            ...
            if (IndexViewModel.errores_mo().length == 0) {//se activa las validaciones                       
                if(self.desgl_mo.id()==0){
                    var parametros={                     
                        ...
                        url:path_principal+'/api/avanceObraLiteDesgl-mo/',//url api
                   ...
                   RequestFormData(parametros);                                
                    ...
                    var parametros={
                        ...
                        url:path_principal+'/api/avanceObraLiteDesgl-mo/'+self.desgl_mo.id()+'/',
                        parametros:self.desgl_mo                        
                    };
                    RequestFormData(parametros);			
                }
    ...
    self.exportar_excel=function(){
        location.href=path_principal+"/avanceObraLite/excel_desgl_mo/?dato="+self.filtro()+"&uucc_id="+self.desgl_mo.uucc_id();  
    } 
    ...
    self.consultar_por_id=function(obj){         
        ...
        path = path_principal+'/api/avanceObraLiteDesgl-mo/'+obj.id+'/?format=json';
        parameter = {};
        RequestGet(function (datos, estado, mensage) {                        
    ...
    self.paginacion.pagina_actual.subscribe(function (pagina) {    
     ...
     self.desglose_mat = function(obj){        
        location.href=path_principal+"/avanceObraLite/mo/"+obj.id+"/";
    }      
