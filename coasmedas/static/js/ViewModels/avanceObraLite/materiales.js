function IndexViewModel() {
    ...
    self.cargar =function(pagina){        
        ...
        path = path_principal+'/api/avanceObraLiteMateriales/?format=json&page='+pagina;
    ...
    self.eliminar=function(){
        var lista_id=[];
         ...
         if(count==0){
             ...
             var path =path_principal+'/avanceObraLite/eliminar_id_materiales/';
         ...
         if (IndexViewModel.errores_material().length == 0) {//se activa las validaciones           
            if(self.material.id()==0){
                var parametros={                     
                    ...
                    url:path_principal+'/api/avanceObraLiteMateriales/',//url api
               ...
               RequestFormData(parametros);                                
                ...
                var parametros={
					...
					url:path_principal+'/api/avanceObraLiteUUCC/'+self.material.id()+'/',
					parametros:self.material                        
				};
				RequestFormData(parametros);			
            }
    ...
    self.exportar_excel=function(){
        location.href=path_principal+"/avanceObraLite/excel_mat/?dato="+self.filtro()+"&catalogo_id="+self.material.catalogo_id();
    } 
    ...
    self.consultar_por_id=function(obj){         
        ...
        path = path_principal+'/api/avanceObraLiteMateriales/'+obj.id+'/?format=json';
        parameter = {};
        RequestGet(function (datos, estado, mensage) {                        
