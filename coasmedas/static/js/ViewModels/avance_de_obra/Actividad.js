    ...
    self.guardar=function(){
        ...
        if (ActividadViewModel.errores_actividad().length == 0) {//se activa las validaciones
           ...
           // self.contratistaVO.logo($('#archivo')[0].files[0]);
            self.actividadVO.cronograma_id($("#id_cronograma").val());
            if(self.actividadVO.id()==0){
                ...
                var parametros={                     
                     ...
                     url:path_principal+'/api/Actividad_avance_obra/',//url api
   ...
   //exportar excel
    ...
    self.consultar = function (pagina) {
        if (pagina > 0) {            
            ...
            path = path_principal+'/avance_de_obra/listar_actividades/'+$("#id_cronograma").val();
            parameter = {};
    ...
    self.consultar_por_id = function (obj) {
      ...
      // alert(obj.id)
       ...
       path =path_principal+'/api/Actividad_avance_obra/'+obj.id+'/?format=json';
    ...
    self.eliminar = function () {
         ...
         if(count==0){
             ...
             var path =path_principal+'/avance_de_obra/eliminar_id_capitulos/';
