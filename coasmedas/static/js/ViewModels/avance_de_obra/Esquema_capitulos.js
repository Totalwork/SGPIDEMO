function AdministrarViewModel() {
   ...
   // self.url=path_principal+'api/Banco';   
    ...
    self.clonar_esquema=function(){
        ...
        if (AdministrarViewModel.errores_clonacion().length == 0) {//se activa las validaciones
                ...
                var parametros={                     
                     ...
                     url:path_principal+'/avance_de_obra/clonacion_esquema/',//url api
    ...
    self.agregar_capitulos=function(obj){
        ...
        location.href=path_principal+"/avance_de_obra/administrar_actividades/"+obj.id;
    }

    self.regla_estado=function(obj){
        
        location.href=path_principal+"/avance_de_obra/regla_estado/"+obj.id;
    }
    ...
    self.consultar = function (pagina) {
        if (pagina > 0) {            
            ...
            sessionStorage.setItem("dato_esquema_capitulo",self.filtro() || '');
            path = path_principal+'/api/Esquema_Capitulos_avance_obra/?format=json&page='+pagina;
    ...
    self.consultar_por_id = function (obj) {
      ...
      // alert(obj.id)
       path =path_principal+'/api/Esquema_Capitulos_avance_obra/'+obj.id+'/?format=json';
           ...
           // self.contratistaVO.logo($('#archivo')[0].files[0]);
            ...
            if(self.etiquetaVO.id()==0){
                ...
                var parametros={                     
                     ...
                     url:path_principal+'/api/Esquema_Capitulos_avance_obra/',//url api
                ...
                Request(parametros);
                  ...
                  var parametros={     
                       ...
                       url:path_principal+'/api/Esquema_Capitulos_avance_obra/'+self.etiquetaVO.id()+'/',
                       parametros:self.etiquetaVO                        
                  };
    ...
    self.eliminar = function () {
         ...
         if(count==0){
             ...
             var path =path_principal+'/avance_de_obra/eliminar_esquema/';
...
$('#txtBuscar').val(sessionStorage.getItem("dato_esquema_capitulo"));
