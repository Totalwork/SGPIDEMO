...
function CuentaViewModel() {
    ...
    self.macrocontrato_select.subscribe(function (valor) {
            ...
            if(valor>0){
                 ...
                 parameter={ mcontrato: valor,liteD:'2' };
                 RequestGet(function (datos, estado, mensaje) {
    ...
    self.exportar_informe=function(){
        ...
        if(self.macrocontrato_select()==0){
            ...
            location.href=path_principal+"/financiero/descargar_informe_anticipos/?macrocontrato_id="+self.macrocontrato_select()+"&fecha="+self.fecha()+"&activar="+self.activar()+"&contrato_id="+self.contrato_select();
        }
