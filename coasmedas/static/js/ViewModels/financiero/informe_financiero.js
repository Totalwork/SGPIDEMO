...
function CuentaViewModel() {
    ...
    self.exportar_informe=function(){
        ...
        if(self.macrocontrato_select()==0){
            ...
            location.href=path_principal+"/financiero/descargar_informe_financiero/?macrocontrato_id="+self.macrocontrato_select()+"&fecha="+self.fecha()+"&activar="+self.activar()+"&contrato_id="+self.contrato_select();
        }
