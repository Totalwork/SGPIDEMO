...
function Detalle_giroViewModel() {
    ...
    self.encabezado_detalle=function(encabezado){
        /*var encabezado_id=self.detalle_giroVO.encabezado_id();*/
         path =path_principal+'/api/Encabezado_giro/'+encabezado;
         parameter={};
    ...
    self.consultar = function (pagina) {
        ...
        if (pagina > 0) {            
            ...
            path = path_principal+'/api/Rechazo_giro/?format=json&page='+pagina;
            parameter = { desde:self.desde(),hasta:self.hasta(),contratista:self.contratista(),testop:self.test_op(), pagina: pagina, rechazados:1};
